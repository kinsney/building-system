...
<svg xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 1080 1080" class="v-materials specular" @click.stop="afterClick($event)" id="spe">
  <component is="color" v-if="current == 'junior'" :value.sync="value" :BRangle.sync="BRangle" :BLangle.sync="BLangle" :current.sync="current"></component>
