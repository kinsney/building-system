...
<svg xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 1080 1080" class="v-materials" @click.stop="afterClick($event)" id="regular">
  <component is="color" v-if="current == 'junior'"  :value.sync="color" :BRangle.sync="BRangle" :BLangle.sync="BLangle" :current.sync="current" :colorpad.sync="colorpad" :material.sync="material"></component>
