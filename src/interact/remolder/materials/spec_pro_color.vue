...
<g id="Color_P">
  <g>
    <defs>
      <path id="SVGID_1_1" d="M867.2,309.9C740,129.2,490.5,85.9,309.8,213C129.2,340.2,85.8,589.7,213,770.4s376.7,224,557.3,96.8
...
<g id="Monitor_P">
  ...
  <text xmlns="http://www.w3.org/2000/svg" transform="matrix(1 0 0 1 484.3381 482)">
    ...
    <tspan x="-25" y="130" style="font-size:120px;font-family:'HYg1gj'" v-text="change.value">75</tspan>
    <tspan x="-20" y="120" style="font-size:50px;font-family:'HYg1gj'" v-text="change.hover"></tspan>
...
<style type="text/css">
  #spe .st0{fill:#333333;}
  #spe .st1{fill:#F5D96C;}
  #spe .st2{clip-path:url(#SVGID_2_1);}
